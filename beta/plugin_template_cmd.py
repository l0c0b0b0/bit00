...
# =============================================================================        
        ...
        cmd = f"""
        /usr/bin/nuclei -no-color -silent -no-interactsh -target {target} -rate-limit 50 -concurrency 5 -retries 2 -max-host-error 2 \\
            -o {output_file} | sed 's/\\[tech-detect:\\([^]]*\\)\\]/web-tech: \\1 /g'
    """
