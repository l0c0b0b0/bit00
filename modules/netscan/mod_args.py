...
def mod_args(subparsers: argparse._SubParsersAction, parents: list) -> argparse.ArgumentParser:
    ...
    netscan_parser.add_argument('-r', '--results', action='store', default=False, dest='results', help='Create the report in MarkDown, Json and Xml. Default: It will execute after finish all targets')
